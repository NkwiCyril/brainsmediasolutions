...
class ServiceController extends Controller
{
    protected function getServices()
    {
        return [
            (object) [
                ...
                'image' => asset('brainsmedia/assets/img/hero-carousel/web_dev-1.jpg')
            ],
            (object) [
                'icon' => 'bar-chart',
                ...
                'image' => asset('brainsmedia/assets/img/hero-carousel/digital-2.png')
            ],
            (object) [
                'icon' => 'phone',
                ...
                'image' => asset('brainsmedia/assets/img/hero-carousel/app-dev.jpg')
            ],
        ];
    }
    ...
    {
        $service = collect($this->getServices())->firstWhere('slug', $slug);
